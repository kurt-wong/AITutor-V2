...
| 科目 | 典型综合题特征 | 典型独立题特征 |
|---|---|---|
| **数学** | 较少综合题；解答题有多个小问但通常独立 | 选择题、填空题、单个解答题 |
| **物理** | 实验题有多步骤小问 | 选择题、单个计算题 |
| **化学** | 实验综合题有多步骤小问 | 单选题、单个计算题 |
| **生物** | 实验综合题有多步骤小问 | 选择题、单个简答题 |
| **语文** | 材料阅读（多题共用材料）、文言文/古诗（多题共用原文）、文学类阅读（多题共用文章） | 默写、微写作、写作 |
| **英语** | 完形填空（一篇短文+多空）、阅读理解（一篇文章+多题）、七选五（一篇文章+多空）、语法填空（一篇短文+多空） | 独立写作、独立翻译 |
