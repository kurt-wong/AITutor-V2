...
Version: 6.22
Status: 9 科答案基线 mismatch=0、严格 209/231 (90%)；历史 Q37 修复 42/43；物理 11/20 为主要缺口
Date: 2026-08-25
...
9 科答案基线已提升至 mismatch=0、严格通过 **209/231 (90%)**。本轮完成：数学 LaTeX
...
- 9 科答案基线：mismatch=0，严格通过 **209/231 (90%)**；答U 19、答M 0。
- 各科严格：语文 22/24、数学 22/23、历史 42/43、政治 28/28、生物 24/24、化学 25/26、
  英语 10/11、地理 25/30、物理 11/20（主要缺口：答案证据 9 题不可验证）。
- 历史 Q37 已修复（重跑 LLM 重标注）；新遗留 Q26 选项 D 缺失。
- 物理 mimo-vl 重跑：严格 11/20，选项 18/20，stem 18/20；paddle 401 已由 mimo 兜底。
...
1. 物理答案证据缺口（11/20）：no_answer_evidence 3、composite_subquestion 2、
   free_text 2、缺库 2——需调查 mimo OCR 答案区识别与锚点。
2. 语文 Q17 串题 + 答案冲突（真实数据问题）人工审核。
3. 历史 Q26 选项 D 缺失。
